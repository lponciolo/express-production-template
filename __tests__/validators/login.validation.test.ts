...
describe('Admin Service -> getAdminWelcome', () => {
    ...
    it('should throw Validation error: \"password\" is required', async () => {
        ...
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"password\" is required")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
    it('should throw Validation error: \"password\" is not allowed to be empty', async () => {
        ...
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"password\" is not allowed to be empty")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
    ...
    it('should throw Validation error: \"password\" must be a string', async () => {
        ...
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"password\" must be a string")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
    it('should throw "Validation error: \"username\" is required"', async () => {
        const mockRequest: any = { body: { password: "password" } }
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"username\" is required")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
    it('should throw Validation error: \"username\" is not allowed to be empty', async () => {
        ...
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"username\" is not allowed to be empty")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
    ...
    it('should throw Validation error: \"username\" must be a string', async () => {
        ...
        expect(() =>{loginValidationSchema(mockRequest, emptyRes, emptyNext)}).toThrow("Validation error: \"username\" must be a string")
        expect(mockValidateRequest).toHaveBeenCalledTimes(1)
    })
